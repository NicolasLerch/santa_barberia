// const credentialsfile = require('../config/credentials');
const fs = require("fs");
...
const calendlyService = {
  ...
  getEvents: async (req, res) => {
    ...
    let start_time_query = req.query.min_start_time && req.query.min_start_time !== 'null' ? req.query.min_start_time : new Date()
    let max_time_query = req.query.max_start_time && req.query.max_start_time !== 'null' ? req.query.max_start_time : new Date()
  ...
  getInvitees: async (req, res) => {
    url = "https://api.calendly.com/scheduled_events/c218d97c-5ed1-4b74-8523-660f059ee0ec/invitees";
    ...
    for(let i = 0; i < eventIds.length; i++) {
        ...
        let phoneAnswer = eventURL.collection[0].questions_and_answers.length > 0 ? eventURL.collection[0].questions_and_answers[0].answer : null;
  ...
  showEvents: async (req, res) => {
    ...
    let start_date = req.body.min_start_date; 
